/** Header file generated with fdesign on Thu Nov 11 10:18:54 2004.**/
...
typedef struct {
	...
	FL_OBJECT *comment;
	FL_OBJECT *framespeed;
	FL_OBJECT *interpolations;
} FD_main;
