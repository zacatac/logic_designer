...
void find_regions(void) {
  ...
  if(ss) {
#ifdef DEBUG
    printf("Found Complete Single Strand 2D-Structure\n");
#endif
    bases[1].mate = nbase;
    bases[nbase].mate = 1;
  }
...
save_naview(struc_t *the_struc) {
	...
	printf("Lengths differ in nbase and struc_t\n");
	return NULL;
    }
    xmin = bases[1].x;
    xmax = bases[1].x;
